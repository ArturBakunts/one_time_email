...
def check_mail(mail=''):
    ...
    if length == 0:
        print('[INFO] There are no new messages in the mail yet. Mail is updated automatically every 5 seconds')
    else:
        id_list = []
        ...
        print(f'[+] You have {length} new messages!Mail is updated automatically every 5 seconds!')
...
def delete_mail(mail=''):
    ...
    print(f'[X] Email address {mail} - removed!\n')
